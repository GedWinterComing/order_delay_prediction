...
Final Choice: CatBoost * Evaluation Metric: The model was optimized for Recall on the "late order" class. From a business perspective, it is preferable to flag more at-risk orders (accepting some false positives) rather than missing a critical delay.
